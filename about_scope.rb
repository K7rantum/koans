...
class AboutScope < EdgeCase::Koan
  ...
  # NOTE:
  # Though the classes above are both named Dog, they are in fact different classes
  ...
  # NOTE:
  # "HI".class does return <String> but the word String above is really AboutScope::String
  # Since it's a class we create in our file here AboutScope
  ...
  # NOTE:
  # Remember... ClassName.const_get("ConstantName")
  # const_get will find the specified constant in the specified class, amazing!
